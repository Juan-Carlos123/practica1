				...
				<div class="panel-body">					
					<div class="table-container">
						<form method="POST" action="{{ route('libro.store') }}"  role="form">
							...
							<div class="form-group">
								<textarea name="resumen" type="text" class="form-control input-sm" placeholder="Resumen"></textarea>
							</div>
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
							...
							<div class="form-group">
								<textarea name="autor" type="text" class="form-control input-sm" placeholder="Autor"></textarea>
							</div>
							<div class="row">
